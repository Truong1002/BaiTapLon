<?php
    ...
    if ($_GET['to'] != -1) {
        $from = $_GET['from'];
        $to = $_GET['to'];
        $sql = "SELECT COUNT(*) FROM tbl_sanpham WHERE gia > $from*1000000 AND gia < $to*1000000 AND trangthai = 1";
        $sql_pro = "SELECT * FROM tbl_sanpham WHERE gia > $from*1000000 AND gia < $to*1000000 AND trangthai = 1 ORDER BY id_sp ASC LIMIT $begin, 16";
    } else {
        $from = $_GET['from'];
        $sql = "SELECT COUNT(*) FROM tbl_sanpham WHERE gia > $from*1000000 AND trangthai = 1";
        $sql_pro = "SELECT * FROM tbl_sanpham WHERE gia > $from*1000000 AND trangthai = 1
