...
//
$sql_sp = "SELECT * FROM tbl_sanpham WHERE trangthai=1 AND ten_sp LIKE '%".$tukhoa."%' ORDER BY id_sp ASC LIMiT $begin, 16";
...
<div class="product">
    <div class="container">
        <p class="product-heading mt-0 py-3 fs-5 fw-semibold">Từ khóa tìm kiếm: <?php echo $tukhoa ?> (<?php echo $total_sp ?>)</p>
